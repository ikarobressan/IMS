...
class EnviarFotoGaleria extends StatefulWidget {
  const EnviarFotoGaleria({super.key});

  @override
  State<EnviarFotoGaleria> createState() => _EnviarFotoGaleriaState();
}

class _EnviarFotoGaleriaState extends State<EnviarFotoGaleria> {
